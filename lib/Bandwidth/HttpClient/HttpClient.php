...
use Bandwidth\HttpClient\AuthHandler;
use Bandwidth\HttpClient\ErrorHandler;
use Bandwidth\HttpClient\RequestHandler;
use Bandwidth\HttpClient\Response;
use Bandwidth\HttpClient\ResponseHandler;
...
class HttpClient
{
    protected $options = array(
        'base'    => 'https://api.catapult.inetwork.com',
        'api_version' => 'v1',
